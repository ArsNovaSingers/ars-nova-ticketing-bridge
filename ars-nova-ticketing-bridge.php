...
/**
 * v1.24.0 - the concert reminder email.
 *
 * Its own WC_Email rather than a reused order notification, so staff can edit
 * subject, heading and opening paragraph under WooCommerce > Settings > Emails,
